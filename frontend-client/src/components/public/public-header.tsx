...
import { MegaMenu } from '@client/components/public/mega-menu'
import { MobileNavigation } from '@client/components/public/mobile-navigation'
import { SearchDialog } from '@client/components/public/search-dialog'
import { QtsLogo } from '@/components/shared/qts-logo'
import { buttonVariants } from '@/components/ui/button'
import { publicNavigation } from '@client/config/marketing'
